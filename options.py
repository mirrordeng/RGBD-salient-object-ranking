...
parser.add_argument('--gt_root', type=str, default='../BBS_dataset/RGBD_for_train/GT_new/', help='the training gt images root')
...
parser.add_argument('--test_gt_root', type=str, default='../BBS_dataset/test_in_train/GT_new/', help='the test gt images root')
